...
func (t *changesTransformation) SetRoad(m map[string]int, m2 map[string]string, transformation *execute.Transformation, state *execute.ExecutionState) {
	panic("implement me")
}

func (t *changesTransformation) GetRoad(s string, i int) (*execute.ConsecutiveTransport, *execute.Transformation) {
	panic("implement me")
}

func (t *changesTransformation) GetEs() *execute.ExecutionState {
	panic("implement me")
}

func (t *changesTransformation) SetWG(WG *sync.WaitGroup) {
	panic("implement me")
}
...
func (t *changesTransformation) Finish(id execute.DatasetID, err error, windowModel bool) {
